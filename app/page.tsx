      ...
      <ErrorBoundary>
        ...
        <div className="flex">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6">
            <div className="flex items-center justify-between sm:justify-start space-x-2 sm:space-x-3 mb-3 sm:mb-0">
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <Badge variant="secondary" className="bg-primary/10 text-primary flex items-center gap-1 text-xs">
                  ...
                  Active
                             ...
                             <div className="flex items-center space-x-2 sm:hidden pr-2">
                 <Button className="bg-primary hover:bg-primary/90 rounded-full text-xs px-3 py-2">
                   Share
                 </Button>
            ...
            <div className="hidden sm:flex items-center space-x-2">
              <Button className="bg-primary hover:bg-primary/90 rounded-full text-sm px-3 py-2">
                Share
              </Button>
